/*
  ...
  - You are about to drop the column `end` on the `Candidate` table. All the data in the column will be lost.
  - You are about to drop the column `start` on the `Candidate` table. All the data in the column will be lost.
